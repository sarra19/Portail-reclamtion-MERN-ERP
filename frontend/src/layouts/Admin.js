...
import AddRép from "views/admin/Réponse/AddReponse";
import AddService from "views/admin/Service/AddService";
import ModifyRéc from "views/admin/Réclamation/ModifyRéc";
      ...
      <div className="relative md:ml-64 bg-blueGray-100">
        ...
        <div className="px-4 md:px-10 mx-auto w-full -m-24">
          <Switch>
            ...
            <Route path="/admin/modify-réclamation" exact component={ModifyRéc} />
            <Route path="/admin/delete-réclamation" exact component={AddUsers} />
            <Route path="/admin/details-réclamation" exact component={DetailsRéc} />
            ...
            <Route path="/admin/modify-service" exact component={ModifyService} />
            <Route path="/admin/détails-service" exact component={DétailsService} />

            <Route path="/admin/intervention" exact component={Interventions} />
            <Route path="/admin/détails-intervention" exact component={DétailsInterv} />
            ...
            <Route path="/admin/détails-remboursement" exact component={DétailsRemb} />

            <Route path="/admin/historique" exact component={Historique} />
            <Route path="/admin/détails-historique" exact component={DétailsHistorique} />

            <Route path="/admin/add-réponse" exact component={AddRép} />
