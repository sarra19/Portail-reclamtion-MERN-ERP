  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 w-full h-full z-10 flex justify-between items-center bg-slate-200 bg-opacity-50'>
       <div className='mx-auto  bg-white border border-orange-dys  shadow-md p-4 w-32 max-w-sm'>
            ...
            <h1 className='pb-4 text-lg text-orange-dys font-semibold'>Changer le Role d'utilisateur</h1>
            ...
            <button className='w-fit mx-auto block  py-1 px-3 rounded-full bg-orange-dys text-white hover:bg-orange-dys' onClick={updateUserRole}>Change Role</button>
       </div>
    </div>
  )
}
