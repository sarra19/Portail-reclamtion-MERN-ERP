...
import NotificationDropdownBack from "components/Dropdowns/TableDropdownBack";
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <div className="flex">
                    ...
                    <a href="/admin/modify-remboursement">
                    ...
                    <a href="/admin/détails-remboursement">
...
CardTableRemb.defaultProps = {
  color: "light",
};

CardTableRemb.propTypes = {
