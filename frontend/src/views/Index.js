          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-white">
                Votre Partenaire d'Excellence en Solutions Microsoft
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-white">
                Société de services en ingénierie informatique (SSII) reconnue pour son expertise et son
                partenariat stratégique avec Microsoft, spécialisée dans l'intégration de solutions ERP.
              </p>
              <div className="mt-12">
                <button
                  className="bg-orange-dys text-white active:bg-lightBlue-600 font-bold uppercase px-6 py-4 mt-4 shadow hover:shadow-md outline-none focus:outline-none mr-1 animate-ease-in-out animate-fill-forwards hover:animate-jump hover:animate-once hover:animate-duration-[2000ms] hover:animate-delay-0"
                  type="button"
                >
                  Commencer
                  <i class="fas fa-arrow-right text-white ml-2"></i>                </button>
